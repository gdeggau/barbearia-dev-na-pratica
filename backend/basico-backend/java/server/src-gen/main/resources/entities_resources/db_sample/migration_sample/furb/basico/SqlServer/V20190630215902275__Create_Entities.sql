/* Database: SqlServer. Generation date: 2019-06-30 21:59:02:275 */
/* Entity Fregues */
...
alter table atendimento add constraint fksn6gnpc3ifybu7dxj6teziuuzgnu foreign key (fregues) references fregues (id);
alter table atendimento add constraint fkb2hccqd6topcrf4i7tvhdl9srwjq foreign key (funcionario) references funcionario (id);
alter table atendimento_servicos add constraint fkgzdyaoiachxcv8wrh2yt71u47axe foreign key (atendimento_id) references atendimento (id);
alter table atendimento_servicos add constraint fkxtyvpshi45ihkg1y7dertktrlpdu foreign key (servicos_id) references servico (id);
