/* Database: PostgreSql. Generation date: 2019-06-25 21:32:42:515 */
/* Entity Fregues */
...
alter table atendimento add constraint fkokehtdjrzy3rdydxaueikmaf5auk foreign key (fregues) references fregues (id);
alter table atendimento add constraint fkgcuqowproopv1km7w8r9jpeawkfu foreign key (funcionario) references funcionario (id);
alter table atendimento_servicos add constraint fkvbehhezzpoymemdwcsgmpsu2ka5t foreign key (atendimento_id) references atendimento (id);
alter table atendimento_servicos add constraint fk7dawxvwsf70slu4dfk45huka29e2 foreign key (servicos_id) references servico (id);
