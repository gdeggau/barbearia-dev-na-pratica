/* Database: Oracle. Generation date: 2019-06-25 21:32:42:526 */
/* Entity Fregues */
...
alter table atendimento add constraint fks8d0hszhzovnp1rxyehnehnlstpi foreign key (fregues) references fregues (id);
alter table atendimento add constraint fkveiszidp1oygth9h7111poekfrts foreign key (funcionario) references funcionario (id);
alter table atendimento_servicos add constraint fkgsxcbzlpajg6te32hbrsdat6vdfa foreign key (atendimento_id) references atendimento (id);
alter table atendimento_servicos add constraint fkp8tyux2aw4yoz0w90ifkau6nwiox foreign key (servicos_id) references servico (id);
