/* Database: SqlServer. Generation date: 2019-06-25 21:32:42:520 */
/* Entity Fregues */
...
alter table atendimento add constraint fkfug1nlxypcn8h4pslhzrnzpaug4y foreign key (fregues) references fregues (id);
alter table atendimento add constraint fktbrhc0abfpcwplpswedlw5hqdhj9 foreign key (funcionario) references funcionario (id);
alter table atendimento_servicos add constraint fk2czh5iuoyd9kypdp17i9qjawimwb foreign key (atendimento_id) references atendimento (id);
alter table atendimento_servicos add constraint fkkvxzda9fgioglox2lfu5e0cp6baq foreign key (servicos_id) references servico (id);
