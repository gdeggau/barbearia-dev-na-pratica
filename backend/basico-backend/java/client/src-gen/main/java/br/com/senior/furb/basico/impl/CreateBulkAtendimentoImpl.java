 ...
 * 
 */
public class CreateBulkAtendimentoImpl {
	...
	public CreateBulkAtendimentoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkAtendimentoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_ATENDIMENTO, //
	...
	*/
	public CreateBulkAtendimentoOutput createBulkAtendimento(CreateBulkAtendimentoInput input, long timeout) {
		...
		CreateBulkAtendimentoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkAtendimentoOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkAtendimentoOutput> createBulkAtendimentoRequest(CreateBulkAtendimentoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkAtendimentoOutput.class);
	}
