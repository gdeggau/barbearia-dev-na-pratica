...
public class ExportServicoOutput {
    
    public String exportJobId;
    
    public ExportServicoOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportServicoOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportServicoOutput)) {
            return false;
        }
        ExportServicoOutput other = (ExportServicoOutput) obj;
