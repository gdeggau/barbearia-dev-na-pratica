 ...
 * 
 */
public class ExportFreguesImpl {
	...
	public ExportFreguesImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ExportFreguesInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.EXPORT_FREGUES, //
	...
	*/
	public ExportFreguesOutput exportFregues(ExportFreguesInput input, long timeout) {
		...
		ExportFreguesOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ExportFreguesOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ExportFreguesOutput> exportFreguesRequest(ExportFreguesInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportFreguesOutput.class);
	}
