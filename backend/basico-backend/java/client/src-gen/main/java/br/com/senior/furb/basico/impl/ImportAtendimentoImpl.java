 ...
 * 
 */
public class ImportAtendimentoImpl {
	...
	public ImportAtendimentoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ImportAtendimentoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.IMPORT_ATENDIMENTO, //
	...
	*/
	public ImportAtendimentoOutput importAtendimento(ImportAtendimentoInput input, long timeout) {
		...
		ImportAtendimentoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ImportAtendimentoOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ImportAtendimentoOutput> importAtendimentoRequest(ImportAtendimentoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ImportAtendimentoOutput.class);
	}
