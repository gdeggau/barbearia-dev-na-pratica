 ...
 * 
 */
public class ExportServicoImpl {
	...
	public ExportServicoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ExportServicoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.EXPORT_SERVICO, //
	...
	*/
	public ExportServicoOutput exportServico(ExportServicoInput input, long timeout) {
		...
		ExportServicoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ExportServicoOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ExportServicoOutput> exportServicoRequest(ExportServicoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportServicoOutput.class);
	}
