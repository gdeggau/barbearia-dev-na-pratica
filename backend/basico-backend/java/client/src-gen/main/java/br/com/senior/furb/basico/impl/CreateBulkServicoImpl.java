 ...
 * 
 */
public class CreateBulkServicoImpl {
	...
	public CreateBulkServicoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkServicoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_SERVICO, //
	...
	*/
	public CreateBulkServicoOutput createBulkServico(CreateBulkServicoInput input, long timeout) {
		...
		CreateBulkServicoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkServicoOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkServicoOutput> createBulkServicoRequest(CreateBulkServicoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkServicoOutput.class);
	}
