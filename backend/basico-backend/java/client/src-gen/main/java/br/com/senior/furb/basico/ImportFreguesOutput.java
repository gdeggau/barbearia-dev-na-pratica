...
public class ImportFreguesOutput {
    
    public String importJobId;
    
    public ImportFreguesOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportFreguesOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportFreguesOutput)) {
            return false;
        }
        ImportFreguesOutput other = (ImportFreguesOutput) obj;
