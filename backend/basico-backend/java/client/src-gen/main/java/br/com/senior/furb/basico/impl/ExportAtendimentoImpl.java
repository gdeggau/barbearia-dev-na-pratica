 ...
 * 
 */
public class ExportAtendimentoImpl {
	...
	public ExportAtendimentoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(ExportAtendimentoInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.EXPORT_ATENDIMENTO, //
	...
	*/
	public ExportAtendimentoOutput exportAtendimento(ExportAtendimentoInput input, long timeout) {
		...
		ExportAtendimentoOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), ExportAtendimentoOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<ExportAtendimentoOutput> exportAtendimentoRequest(ExportAtendimentoInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, ExportAtendimentoOutput.class);
	}
