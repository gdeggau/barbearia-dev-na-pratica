...
public class ImportFuncionarioOutput {
    
    public String importJobId;
    
    public ImportFuncionarioOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportFuncionarioOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportFuncionarioOutput)) {
            return false;
        }
        ImportFuncionarioOutput other = (ImportFuncionarioOutput) obj;
