 ...
 * 
 */
public class UpdateMergeServicoImpl {
	...
	public UpdateMergeServicoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Servico input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.UPDATE_MERGE_SERVICO, //
	...
	*/
	public Servico updateMergeServico(Servico input, long timeout) {
		...
		Servico output = DtoJsonConverter.toDTO(resultMessage.getContent(), Servico.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<Servico> updateMergeServicoRequest(Servico input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, Servico.class);
	}
