 ...
 * 
 */
public class UpdateMergeAtendimentoImpl {
	...
	public UpdateMergeAtendimentoImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(Atendimento input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.UPDATE_MERGE_ATENDIMENTO, //
	...
	*/
	public Atendimento updateMergeAtendimento(Atendimento input, long timeout) {
		...
		Atendimento output = DtoJsonConverter.toDTO(resultMessage.getContent(), Atendimento.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<Atendimento> updateMergeAtendimentoRequest(Atendimento input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, Atendimento.class);
	}
