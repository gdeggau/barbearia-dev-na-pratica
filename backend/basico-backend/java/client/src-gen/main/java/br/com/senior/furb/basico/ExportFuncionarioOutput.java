...
public class ExportFuncionarioOutput {
    
    public String exportJobId;
    
    public ExportFuncionarioOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportFuncionarioOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportFuncionarioOutput)) {
            return false;
        }
        ExportFuncionarioOutput other = (ExportFuncionarioOutput) obj;
