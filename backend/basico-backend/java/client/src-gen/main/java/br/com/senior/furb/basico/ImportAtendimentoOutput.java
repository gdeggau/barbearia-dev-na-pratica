...
public class ImportAtendimentoOutput {
    
    public String importJobId;
    
    public ImportAtendimentoOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ImportAtendimentoOutput(String importJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ImportAtendimentoOutput)) {
            return false;
        }
        ImportAtendimentoOutput other = (ImportAtendimentoOutput) obj;
