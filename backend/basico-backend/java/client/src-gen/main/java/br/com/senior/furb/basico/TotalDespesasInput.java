...
public class TotalDespesasInput {
    
    public java.time.LocalDate dataInicial;
    public java.time.LocalDate dataFinal;
    
    public TotalDespesasInput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public TotalDespesasInput(java.time.LocalDate dataInicial, java.time.LocalDate dataFinal) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof TotalDespesasInput)) {
            return false;
        }
        TotalDespesasInput other = (TotalDespesasInput) obj;
