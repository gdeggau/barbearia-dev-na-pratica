 ...
 * 
 */
public class CreateBulkFreguesImpl {
	...
	public CreateBulkFreguesImpl(Supplier<IMessenger> messengerSupplier, UserIdentifier userId, Supplier<Message> messageSupplier) {
		this.messengerSupplier = messengerSupplier;
		this.userId = userId;
		this.messageSupplier = messageSupplier;
	}

	private Message createMessage(CreateBulkFreguesInput input) {
		if (messageSupplier != null && messageSupplier.get() != null) {
			return messageSupplier.get().followUp( //
				BasicoConstants.DOMAIN, //
				BasicoConstants.SERVICE, //
				BasicoConstants.Commands.CREATE_BULK_FREGUES, //
	...
	*/
	public CreateBulkFreguesOutput createBulkFregues(CreateBulkFreguesInput input, long timeout) {
		...
		CreateBulkFreguesOutput output = DtoJsonConverter.toDTO(resultMessage.getContent(), CreateBulkFreguesOutput.class);
		if (output == null) {
	...
	*/
	public CompletableFuture<CreateBulkFreguesOutput> createBulkFreguesRequest(CreateBulkFreguesInput input) {
		...
		Message message = createMessage(input);
		addMessageHeaders(message);
		return serviceRunner.request(message, CreateBulkFreguesOutput.class);
	}
