...
public class ExportFreguesOutput {
    
    public String exportJobId;
    
    public ExportFreguesOutput() {
    }
    
    /** 
     * This constructor allows initialization of all fields, required and optional.
     */
    public ExportFreguesOutput(String exportJobId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ExportFreguesOutput)) {
            return false;
        }
        ExportFreguesOutput other = (ExportFreguesOutput) obj;
